...
int main(){
    ...
    Bottom_up maxprice_3 = Bottom_up_Cut_Rod(price, 4);
    cout << maxprice << endl;
    cout << maxprice_2 << endl;
    cout << "total length: " << "4" << endl;
    cout << "maximum price: " << maxprice_3.max_price << endl;
    cout << "切法: ";
    for (int i = 0; i < maxprice_3.max_cut_posi.size(); i++){
        cout << maxprice_3.max_cut_posi[i] << " ";
    }
    cout << endl;
    cout << "number of pieces: " << maxprice_3.max_cut_posi.size() << endl;
    cout << endl;
    //////////////////////////////////////////////////////
    cout << "minimum price: " << maxprice_3.min_price << endl;
    cout << "切法: ";
    for (int i = 0; i < maxprice_3.min_cut_posi.size(); i++){
        cout << maxprice_3.min_cut_posi[i] << " ";
    }
    cout << endl;
    cout << "number of pieces: " << maxprice_3.min_cut_posi.size() << endl;
...
Bottom_up Bottom_up_Cut_Rod(int* price, int n){
    ...
    for(int i=1; i<=n; i++){
        ...
        int min_cutIndex = 0;
        for(int j=0; j<i; j++){
            int current_price = price[j] + max_table[i-j-1];
